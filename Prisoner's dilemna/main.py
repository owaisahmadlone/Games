...
class game():
    ...
    def play(self):
        ...
        print(
            f'Round 1: {self.player1.name} : {self.score1}, {self.player2.name} : {self.score2}')
        ...
        for i in range(self.num_rounds-1):
            ...
            move2 = new_move2
            print(
                f'Round {i+2}: {self.player1.name} : {self.score1}, {self.player2.name} : {self.score2}')
        print("GAME ENDED!")
        return
...
if __name__ == "__main__":
    print("Enter player1: ", end="")
    name1 = str(input())
    print("Enter player2: ", end="")
    name2 = str(input())
    ...
    print(f'\nPoints scored by {name1}: {a}, Points scored by {name2} : {b}\n')
